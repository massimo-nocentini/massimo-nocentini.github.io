...
summary = "This manifesto argues that interesting things happen when people deliberately seek novelty, step outside comfort zones, cultivate curiosity, listen well, embrace their peculiarities, and stay open to failure, connection, and experimentation. Being interesting is presented not as a fixed trait, but as a practice of living bravely, learning widely, and creating original paths instead of copying inherited ones."
author = 'The DO Team'
+++

*All the follows are from [the do lectures' post](https://thedolectures.com/manifestos/23-laws-of-interesting/).*

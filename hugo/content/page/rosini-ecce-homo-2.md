...
Allora vediamo un pochino di andare avanti, perché ieri abbiamo fatto molta parte introduttiva e molta parte per inquadrare il discorso, e poi siamo entrati nel racconto della passione così come ce lo consentiva l'ordine di un processo, l'ordine del processo secondo le sue strutture essenziali.
E abbiamo visto che piano piano si scopriva, nel momento in cui si parlava dell'accusa, che il primo punto era il fatto che quest'uomo era pericoloso.

> Se continua così, i Romani ci prendono per sediziosi,

viene detto alla fine del capitolo 11, dopo la resurrezione di Lazzaro, "Vengono e ci fanno fuori".
E detto questo, Caifa dice:

> È meglio che questo muoia.

Questo deve proprio morire. E non ha fatto niente di male, ma è pericoloso.
E il discorso va avanti con l'indagine che abbiamo trovato al capitolo 7, quando abbiamo visto che il soldato schiaffeggia Gesù:

> Così parli? Così rispondi al sommo sacerdote?

E Gesù dice:

> Se ho parlato male, mostrami dov'è il male. Se ho parlato bene, perché mi percuoti?

Abbiamo visto che di fatto quella guardia era uno di quelli che aveva detto:

> Mai un uomo ha parlato come parla quest'uomo.

Allora vuol dire che parla bene. Vuol dire che qui questa istruttoria è una burletta.
E in realtà abbiamo visto che la sentenza riguarda Pietro, il quale non è ancora discepolo, il quale deve arrivarci.

Che cosa succede? Portano Gesù da Caifa, perché chi lo ha interrogato in realtà è Anna, che nemmeno è il vero sommo sacerdote: è quello che manovra l'altro, è il vero capo, ma un capo ufficioso.
Portano da Caifa e non sappiamo che cosa succede con Caifa, perché di fatto è tutta una presa in giro.

A questo punto noi seguiamo Gesù che viene portato da Pilato. Leggiamo:
...
> Pilato dunque uscì verso di loro.
...
Pilato è l'uomo che rappresenta il diritto romano, rappresenta la struttura essenziale della giurisprudenza e non può accettare questo tipo di accusa. No, è un insulto. Gli dice praticamente: *"State facendo delle porcherie madornali.
Come si fa a istituire un processo su questa base?* E a quel punto gli risposero i Giudei:

> A noi non è consentito mettere a morte nessuno.

Perché Roma si era riservata lo *ius gladii*, il diritto di spada. Siccome quella era una terra di teste calde, attenta a sedizioni e rivolte, non potevano condannare a morte nessuno.
La loro legge la potevano esercitare, ma non fino alla pena capitale.
Quindi stanno mettendo un cavillo per incastrarlo.

Lui dice:

> Io non posso mettere in piedi un processo su questa base
...
Adesso dobbiamo ricordare una cosa: fino a questo momento chi ha detto che Gesù è il re dei Giudei? Nessuno.
Da dove scappa fuori questa frase?
Questo magistrato romano lo guarda, lo osserva per la prima volta e gli fa una domanda:

> Sei tu il re dei Giudei?

Infatti Gesù nota questa cosa e risponde:

> Dici questo da te oppure altri ti hanno parlato di me?

Perché dice così Gesù? Perché fin adesso nessuno ne ha parlato.
...
Gesù fino adesso è stato molto frenato. Con Pilato invece si mette a parlare. Gesù dice:
...
Sta giustificando la sua risposta. Perché Gesù gli ha toccato qualcosa. Pilato era andato per interrogare Gesù ma si trova interrogato da Gesù. La sua prima domanda rivela qualcosa che Pilato ha intuito. Gesù riprende a parlare:
...
cioè non me lo dà questo mondo. Il mio regno non è del tipo, del materiale di questo mondo. Perché se fosse del materiale di questo mondo:

> I miei servitori avrebbero combattuto perché non fossi consegnato.

Sta citando Pietro che ha tirato fuori la spada e ha tagliato il lobo dell'orecchio destro. Sta dicendo: *Non è un mio servitore.* I miei servitori non combattono. I miei servitori non tirano fuori la spada. Infatti a Pietro dice:
...
Ce ne siamo pentiti tutte le volte che abbiamo sfoderato la spada. La storia ci ha smentiti tutte le volte che abbiamo smentito questo Signore difendendolo con la spada.
Questo non ha bisogno di essere difeso con la spada. Questo non ha bisogno della violenza.
Questo non lo vince così.
Non è una cosa da imporre in testa agli altri.
Abbiamo dovuto ammettere che abbiamo sbagliato tutte le volte che abbiamo portato il Vangelo a bastonate, a imposizioni, con il potere. Non ci è servito a niente. Abbiamo solamente dovuto pagare — e paghiamo ancora oggi — lo scotto di questo tipo di atteggiamento.
Ed è interessante, perché questa è una cosa strana, inaspettata, imbarazzante, totalmente diversa da quello che Pilato può comprendere.
...
È straordinario.
Perché Gesù fino a questo momento non ha voluto parlare. Invece adesso dialoga, perché lui qui voleva arrivare. Sapeva benissimo che era Roma che lo doveva giudicare.
Roma — il diritto romano, il potere — doveva emettere una sentenza su di lui.
...
Il punto è che questo è il sistema di Pilato per dimostrare che è innocente.
Infatti sentite cosa succede.
Viene torturato in maniera tale da costringerlo a rinnegare ciò che ormai è in ballo:
il fatto che lui sia il re dei Giudei.
...
Le palline entravano nella carne e poi venivano tirate via.
Il colpo entrava e strappava.
...
Allora qual è il punto? Io ho cercato la colpa e non l'ho trovata. _"Ve lo conduco fuori perché voi sappiate, vedendolo, che abbiamo fatto tutto quello che dovevamo fare. Abbiamo massacrato quest'uomo — e questo uomo è un innocente."_

Allora Gesù uscì portando la corona di spine e il mantello di porpora, esce — quello che è, un uomo distrutto. E Pilato disse:
...
Chi può avercela con qualcuno che scappa da una croce — lo vuoi capire? — sta sbagliando. Ma tu non sai perché. Noi non sappiamo, non possiamo mai giudicare finché non vediamo la parte ferita di ognuno. Noi non conosciamo le persone. E solo l'amore ci fa vedere le persone per come sono. Solo l'amore ci dà di conoscere e guardare l'altro — la tenerezza — e ti fa vedere oltre i suoi vanti, i suoi atteggiamenti grotteschi, oltre i suoi tentativi di rendersi commestibile. Dietro ci sta una povera persona ferita. Dietro ogni persona. _Ecco l'Uomo_. Come lo videro i capi dei sacerdoti e le guardie, gridarono:
...
Tre. _Io in lui non trovo colpa_. Non ce l'ha — è innocente. È martellante in questo testo questa definizione. Gli risposero i Giudei:

> "Noi abbiamo la legge e secondo la legge deve morire perché si è fatto figlio di Dio."

Gli rispondono questo e udite queste parole, Pilato ebbe ancora più paura e rientrò nel pretorio. Disse a Gesù:
...
E infatti si arrabbiano. E i capi dei sacerdoti e i Giudei dissero a Pilato:

> "Non scrivere 'il re dei Giudei', ma: 'Costui ha detto: io sono il re dei Giudei.'"

Questa è l'ultima scrittura definitiva del processo — questa è la famosa sentenza. E cosa risponde Pilato?
...
State aspettando da questo Signore che vinca, che vi dia potere, che vi dia forza, che vi dia cultura, che vi dia il piacere della religione — perché noi ci avviciniamo a Dio normalmente per stare bene, normalmente per farci i nostri fatti, per farci tornare i conti. È per questo che noi ci avviciniamo? Questo che risolve i problemi? T'aspetti che risolva tutti i tuoi problemi uno così? Uno che sta messo in queste condizioni? Ma sai che ci siamo scordati chi è il nostro re? No — questo non ci insegna a vincere in questo mondo. Questo ci insegna qualcos'altro. Il suo potere non è di questo mondo. Il suo regno non è di questo mondo.

I soldati, poi, quando ebbero crocifisso Gesù, presero le sue vesti e ne fecero quattro parti — una per ciascun soldato. E la tunica. Ma quella tunica era senza cuciture, tessuta tutta ad un pezzo dall'alto in basso. Perciò dissero tra loro:
...
Sono andati via così. Cioè — non sta succedendo qualcosa di banale: sta succedendo qualcosa che è scritto, cioè che è preparato da Dio. Gesù sta eseguendo uno spartito. Il suo spartito è la volontà di Dio — le Scritture. Sta compiendo le Scritture. Non sta improvvisando.
...
Sta amministrando i suoi sudditi. E che cosa fa? Qual è la sua amministrazione? Gli regala l'uno all'altro. Perché questi sacerdoti sono coloro che si occupano della vostra vita, perché vi servono. Chi gliel'ha detto? Ha preso questo sacerdote, Gesù, gli ha detto: "Vai e fai il padre a questa gente." E a te ha detto: "Vai e ricevi il pane da questo padre." Gli ha detto a questo vescovo: "Vieni qua e ministra questa diocesi e servila." E questo popolo — sii di loro proprietà.

Ha perso la sua proprietà, questo vescovo? Voi siete i possessori — coloro che il mio vescovo amministra. C'è un possessivo: "tua madre", "tuo figlio". C'è un possessivo. Chi ha stabilito che ci dobbiamo voler bene gli uni agli altri? Chi ci ha fatti fratelli, madri, sorelle, padri spirituali — e servizio reciproco — e volerci bene?

Questo è Gesù dalla Croce che ci ha regalati gli uni agli altri. Questa è la Chiesa. La Chiesa non è chiesa perché io mi sveglio stamattina e faccio il prete — ma perché Dio mi chiama a essere un regalo per qualcuno, e l'altro sa di essere un regalo per me.
...
Il mio corpo sarebbe "il mio" — "è per voi". Prendete e mangiate questo.

> "Questo è il mio sangue."

Come però — fortissimo — il simbolo del sangue rappresenta la vita:
...
E poi guardate. No. Povero disgraziato che sta morendo in croce, sofferente — flagellato e torturato. Ma ci avrà diritto di tenersi una madre che gli vuole bene? Ma ci avrà diritto di tenersi un amico? Un amico che c'è, con tanto affetto fra di loro — il discepolo che era più affezionato a lui, quello che si è sempre sentito voluto bene. No — Gesù regala tutto. Regala tutto. Regala tutto questo.

E non ha finito. Dopo questo, Gesù, sapendo che ormai tutto era compiuto, affinché si compisse la Scrittura, disse:

> "Ho sete."

Si compie la Scrittura — è il piano del Padre, la volontà del Padre. Sta compiendo ciò che il Padre ha stabilito. E dice:
...
> "È compiuto!" E chinando il capo, consegnò lo spirito.

--- TODO 59:00 minuti

Bellissima, nella nuova traduzione: "consegnò lo spirito". È l'ultimo atto regale — no, il penultimo: ce ne sarà un altro ancora.

Questa frase — "È compiuto!" — allora noi eravamo abituati a una vecchia traduzione: tante volte abbiamo sentito "tutto è compiuto!" Ecco, questa è una traduzione che, con una parafrasi, una circumlocuzione, cerca di rendere una sola parola che dice Gesù. I padri orientali dicono che questo è un grido di vittoria. Io quando l'ho sentita la prima volta — boh — "s'come... come la pensiamo noi? L'ho fatto, ho finito, e poi posso morire. Ho fatto tutto — compiuto, finito — adesso veramente basta." Questo si dice, no?

"Tutto è compiuto" — e ha emesso lo spirito. Eh — muore. Eh certo che lo spirito... è l'ultimo momento in cui sta cercando di respirare. Perché dovete capire che la crocifissione era fatta così: tu stai con un chiodo sui piedi, un chiodo sulle mani, e quindi con tutto il tuo peso pendi dai tuoi polsi. Questo vuol dire che stai così — e i polmoni non stanno. Chi sta così, sta più basso, sta più schiacciato. Di fatto è una struttura che, prima di tutto, fa combattere il torturato fra la voglia di vivere e la voglia di non soffrire. Allora ogni respiro — Gesù per poter prendere un po' d'aria doveva fare forza sul polso e sui piedi chiodati, fare così. Capite? A un momento si lascia andare — e quindi smette di cercare di respirare. Tira fuori tutto il fiato. Se qualcuno di voi ha mai fatto la prova — bisogna fare per controllare la polmonite e cose qua — devi soffiare molto di più di quanto soffieresti normalmente per tirare fuori tutta l'aria che hai nei polmoni. Ecco — Gesù fa: tutta l'aria che aveva nei polmoni, tutta tutta quanta, fino all'ultimo, esce. E lui ha uno schiacciamento definitivo del suo torace. E finisce di respirare.

In greco dice una parola sola. Allora la traduzione cerca di dare un po' più l'idea di questa cosa. "È compiuto" — che vuol dire in realtà? La parola greca *tetelestai* è un perfetto del verbo *teleo*. Il verbo *teleo* vuol dire "raggiungere lo scopo", "raggiungere il gol", "andare a bersaglio", "colpire il bersaglio". Cioè vuol dire che fondamentalmente lui in quel momento ha detto: "Centro." Assurdo. Sembra grottesco che io dica questo — ma qui è: "punto". Ha detto che per questo è nato: "per rendere testimonianza alla verità." E quando fa questo dice: "L'ho fatto. Adesso è il momento in cui lo faccio."

E muore. Muore dichiarato innocente. Muore avendo regalato tutto. Muore senza aver condannato nessuno. Muore senza avere usato alcuna violenza.

---

E perché questo sarebbe lo scopo? Dobbiamo farci una domanda. Ma questo processo — perché il cuore della Scrittura è un processo. Prendi la Bibbia — qual è la parte più importante della Bibbia? I Vangeli. E qual è la parte più importante dei Vangeli? La passione di Gesù. E che cos'è la passione di Gesù? Un processo. E cosa stabilisce un processo? La verità. E qual è la verità? Lui dice di essere riuscito a dare testimonianza alla verità.

E noi ci dobbiamo domandare: ma questo processo è iniziato adesso? È qualcosa avvenuto a Gerusalemme, grosso modo nel 30 d.C., in quella Pasqua, in quel venerdì grottesco? Quando è iniziato questo processo? E perché ci riguarda tutti?

Sapete come si dice in ebraico "avvocato dell'accusa"? *Satana*. È il nome dell'avvocato dell'accusa — l'accusatore. Quando è stata formulata l'accusa? Di fatto c'è un rimando a un'altra parte — vai a cercare, vai a cercare, e ti troverai con Genesi 3. Quando compare l'accusatore — colui che ha formulato l'accusa:

"Dio non è affidabile. Dio mente. Dio non ti vuole bene. Dio ti vieta cose che puoi mangiare tranquillamente. Dio ti mette dei limiti perché non ti vuole bene. Dio ti ha dato dei problemi perché non ti vuole bene. Dio ti mette delle cose che non riesce a risolvere perché non ti vuole bene. Perché non ti vuole bene. Perché non ti vuole bene. Dio non è affidabile. Dio non è buono."

Questa è stata la cosa. E questa cosa ce l'abbiamo tutti nel cuore — combattiamo in ogni istante contro di essa. In ogni momento, ogni singolo nostro atto di disobbedienza è in realtà un atto di sfiducia nei confronti di Dio. In fondo al cuore dell'uomo abita questa menzogna:

"Non ti fidare di Dio. Non ti fidare delle sue leggi. Non ti fidare di lui. Non metterti nelle sue mani. Difenditi. Sì sì, vai in chiesa — ma attento, fino a un certo punto. E se tuo figlio sta iniziando a coinvolgersi, gli dici: 'Oh oh, non esagerare — queste cose di chiesa, eh, ma sei matto?'"

E noi abbiamo questa dentro. Questa è l'accusa. Sta dentro ogni nostro singolo atto. Questa è la nostra tristezza: noi viviamo da orfani. Noi viviamo con un dubbio — il dubbio sull'amore di Dio.

Il processo arriva qui alla sua essenza. Noi, guardando quest'uomo — "Ecco, guardate questo qui!" — noi guardiamo questo e abbiamo questa attestazione:

"Questo è Dio."

Questo è il volto di Dio. E Roma — cinque volte — "l'innocente". Dio è innocente. Dio è buono. Dio vi vuole bene — ma per niente! Che ti vieta le cose perché ti vuole castrare? Perché ti vuole limitare? Perché ti vuole rendere infelice?

"Sono arrivato azzeccato. Ho messo tutto. E muore."

Tu lo guardi.

---

Siccome quel giorno era il giorno di Pasqua, bisognava toglierlo dalla Croce. Vennero i soldati e spezzarono le gambe agli altri due, perché erano ancora vivi — se gli spezzano i garretti, non ce la fanno più a respirare e muoiono dopo poco, soffocati. Ma venendo da Gesù, vedendo che era già morto, non gli spezzarono le ossa. Ma uno dei soldati gli colpì il fianco con la lancia.

Dovete sapere che il colpo che davano i soldati romani era un fatto ben preciso. C'era il soldato specializzato — era il colpo di grazia: veniva colpito da una parte all'altra, veniva squarciato tutto il petto e arrivava fino al cuore. Quella è una ferita mortale definitiva. Quando Tommaso, vedendolo risorto, vorrà vedere quella ferita — perché se è risorto e c'ha quella ferita, è veramente Dio: non è che è guarito, perché da quella ferita non si guarisce.

E colpisce il fianco. E subito uscì sangue e acqua. Sangue separato in siero e plasma di una persona che probabilmente ha avuto un infarto, poi ha avuto un versamento in tutta quella zona, e c'è stata la separazione. Nell'uomo della Sindone, in tutto il sangue uscito da tutte le parti del corpo, è sangue vivo. Il solo sangue che esce da questa ferita è separato in siero e plasma — come succede al sangue quando lo donate. Lo mettono in una sacca che si muove. Non so se avete notato — la busta del sangue si muove, perché il sangue è un organo, dev'essere in movimento. Quando si ferma si separa: la parte più liquida va su e la parte più pesante, corpuscolare, va giù. Questa è rossa, quest'altra è trasparente — il siero. Ebbene, da questa ferita esce quel sangue già separato.

E dice: questo avvenne perché si compisse la Scrittura:

"Non gli sarà spezzato alcun osso."

È l'agnello pasquale — Gesù è morto esattamente nell'ora in cui l'agnello che gli ebrei dovevano mangiare a Pasqua veniva sacrificato al Tempio. È proprio lui — quello che aveva detto Giovanni Battista:

"Ecco l'agnello di Dio."

E un'altra Scrittura dice ancora:

"Volgeranno lo sguardo a colui che hanno trafitto."

Ed è qui il punto: noi dobbiamo volgere lo sguardo a quest'uomo. L'Evangelo di Marco dice che il centurione che ha comandato il plotone, vedendolo morire in tal modo, disse:

"Veramente quest'uomo era figlio di Dio."

E sta dicendo che Dio è quello. Ecco — "volgeranno lo sguardo a colui che hanno trafitto." E volgiamo lo sguardo a questo qui. E questo qui è Dio.

"Dio ha parlato in molti modi attraverso i tempi e i Profeti, ma da ultimo ha parlato in maniera definitiva tramite il suo Figlio."

Così comincia la Lettera agli Ebrei. Questo è Dio. Questo qui. Quel Dio di cui non ti fidi è questa tenerezza qui. Il Dio nelle cui mani non ti abbandoni — perché credi al Satana — è questo innocente qui. È questo amore qui. È questa misericordia qui. È questa assenza totale di violenza.
...
La vita cristiana non è essere forti, ma guardare forte. La vita cristiana non è essere perfetti, ma innamorarsi del Perfetto. La vita cristiana è volgere lo sguardo verso questo Signore qui — l'innocente, il re dei Giudei. Ricevere i suoi regali e riconoscerlo. Riconoscere che ci ama. Riconoscere che tutte le nostre lamentele sono false.

Tutta la mormorazione — la preghiera del demonio — chi brontola, chi mormora, chi non riconosce la generosità della vita... Veramente, la vita ci tratta come meritiamo? Pensa che noi veniamo adesso — mettiamo una macchina sulla testa di qualcuno — e proiettiamo quei pensieri che hai avuto oggi. Se potessero guardare quei pensieri... non se ne potrebbero guardare, perché sarebbe un atto violentissimo. Però Dio quel film l'ha visto. E sai qual era stata la sua sentenza?

"Stasera stai qui."

Ha sentito qualcuno che ti parla di Cristo. Ma senti qualcuno che ti dice:
...
"Lui non ha soldati che vengono a menare. Se qualcuno viene a menare, non viene da lui — lui non l'ha mandato. Lui ha solamente misericordia. Ci ha mandato a dire a tutti del perdono dei peccati."

A quando risorge quest'uomo qui, dice:

"Ecco — io vi mando come il Padre ha mandato me, così io mando voi. A chi rimetterete i peccati saranno rimessi, a chi non li rimetterete resteranno non rimessi."

---

Sapete cosa vuol dire questa frase? Non vuol dire: "Decidete voi chi viene perdonato e chi no." Non è assolutamente questo il senso.

"A chi rimetterete i peccati saranno rimessi."

Quanta gente porta sulle spalle le proprie colpe. Quanta gente porta sulle spalle le colpe degli altri. "A chi rimetterete i peccati" — pure quelle: quello che t'ha toccato quando eri una bambina, quel disgraziato che ha fatto soffrire — c'hai addosso il peccato suo. Qualcuno te lo può togliere. Perché i tuoi peccati sono quelli che ti fanno soffrire di più. Quelli sono quelli che ti fanno soffrire di più.

"A chi rimetterete i peccati saranno rimessi. Ma a chi non li rimetterete resteranno non rimessi."

Cioè: se non lo fate voi, non lo fa nessun altro. Se voi, cristiani, che conoscete questo Dio, non lo annunciate al mondo, non dite al mondo che i peccati sono perdonati, che Dio è buono, che la vita è Provvidenza, che tutto quello che c'è è buono, è santo, è sano, e che Dio ti vuole bene — se non glielo dici tu, ma chi glielo dice? Quello, se tiene i suoi peccati, è un altro discorso — è una responsabilità. Noi abbiamo la responsabilità di far sapere al mondo di questo Signore.

Nel senso: se le persone che ti stanno intorno non trovano in te la misericordia di Dio — in te che sei cristiano — dimmi dove la troveranno. Dico questo: se le donne di questo mondo non amano più i bambini che nascono e li abortiscono, chi li amerà, i bambini? Se i padri non daranno la vita per i loro figli, chi darà la vita per quei ragazzi? Se i fratelli non saranno disposti a morire per i loro fratelli, chi morirà per quelle persone? E se la Chiesa non rimette i peccati, chi rimette i peccati?

Noi siamo stati mandati a questo. C'abbiamo questo da fare. Tutto il resto è secondario — questo è il centro.

"A chi rimetterete i peccati saranno rimessi."

Che bella cosa. Ma se non lo fai, chi lo farà? Se tu non li rimetterai, resteranno non rimessi. Quello si regge, quello vive — una vita senza la notizia della misericordia. Perché Dio ha disposto, in maniera stranissima, che perché io mi salvi devo incontrare un altro cristiano. Non c'è il Vangelo perché io mi salvi — devo trovare qualcuno che mi accolga. Perché la gente del Signore sono me e te che lo accogliamo. Dio ha disposto nel mondo: noi siamo il tramite del suo bene.

---

*Questa era la spiegazione della rimessione dei peccati.*
...
Il Signore sia con voi. E con il suo spirito. Sia benedetto il nome del Signore ora e sempre. Il nostro aiuto nel nome del Signore che ha fatto il cielo e la terra. Vi benedica Dio onnipotente, Padre e Figlio e Spirito Santo. Amen.

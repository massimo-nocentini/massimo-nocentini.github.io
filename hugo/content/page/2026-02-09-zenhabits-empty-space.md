...
summary = "Leo Babauta applies the design principle of white space to everyday life, arguing that leaving room between tasks, possessions, and commitments creates clarity, peace, balance, and greater attention to what matters most. The text proposes a practical path of simplification through breathing, lighter schedules, fewer simultaneous projects, less clutter, and a slower, more deliberate way of living."
author = 'Leo Babauta'
+++

*All the follows are Leo's words from its [post](https://zenhabits.net/space/).*

---

> "Space is the breath of art." ~ Frank Lloyd Wright

I’m not a designer, but I’ve always been in love with the design concept of [white space](http://www.alistapart.com/articles/whitespace).
It’s the space in a design that isn’t filled with things, it’s something I use (perhaps too) liberally.
